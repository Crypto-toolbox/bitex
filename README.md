...
| `dev` (releaseCandidate) | [![Build Status](https://travis-ci.org/Crypto-toolbox/bitex.svg?branch=dev)](https://travis-ci.org/Crypto-toolbox/bitex)     | [![Coverage Status](https://coveralls.io/repos/github/Crypto-toolbox/bitex/badge.svg?branch=dev)](https://coveralls.io/github/Crypto-toolbox/bitex?branch=dev)     | N/A                                                                                                                                          |
| `nightly`                | [![Build Status](https://travis-ci.org/Crypto-toolbox/bitex.svg?branch=nightly)](https://travis-ci.org/Crypto-toolbox/bitex) | [![Coverage Status](https://coveralls.io/repos/github/Crypto-toolbox/bitex/badge.svg?branch=nightly)](https://coveralls.io/github/Crypto-toolbox/bitex?branch=nightly) | N/A                                                                                                                                          |
