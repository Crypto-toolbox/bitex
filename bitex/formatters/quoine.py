"""FormattedResponse Class for Standardized methods of the Quoinex Interface class."""
# Import Built-ins
...
class QuoineFormattedResponse(APIResponse):
    ...
    def ticker(self, *args):
        ...
        return super(QuoineFormattedResponse, self).ticker(bid, ask, high, low, last, volume,
                                                           timestamp)
