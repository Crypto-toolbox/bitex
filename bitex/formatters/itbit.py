"""FormattedResponse Class for Standardized methods of the itBit Interface class."""
# Import Built-ins
...
class ItBitFormattedResponse(APIResponse):
    ...
    def ticker(self, *args):
        ...
        return super(ItBitFormattedResponse, self).ticker(bid, ask, high, low, last, volume,
                                                          timestamp)
